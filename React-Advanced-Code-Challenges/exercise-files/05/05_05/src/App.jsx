...
const ErrorFallback = ({ error }) => {
  return (
    ...
    >
      <pre style={{ color: 'red' }}>Something went wrong: {error.message}</pre>
    </div>
  );
};
...
const WeatherCardwithErrorHandling = withErrorBoundary(WeatherCard)
